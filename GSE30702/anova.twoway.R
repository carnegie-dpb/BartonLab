...
##
## Requires dataframes expr and samples, with samples rows = expr columns; also need array of distinct conditions to be included in analysis, e.g. c("WT","GRREV","GRSTM")
##
